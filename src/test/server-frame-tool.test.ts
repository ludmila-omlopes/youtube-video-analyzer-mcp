    ...
    service: {
      ...
      async getYouTubeFrame(input, context) {
        ...
        return {
          ...
          requestedTimestampSeconds: input.timestampSeconds,
          timestampSource: "requested",
          timestampRefinementReason: null,
          source: "local_exact",
          isExactFrame: true,
          mimeType: "image/jpeg",
  ...
  try {
    ...
    assert.deepEqual(captured[0], {
      input: {
        ...
        timestampRefinementPrompt: undefined,
        timestampRefinementWindowSeconds: undefined,
        timestampRefinementModel: undefined,
      },
